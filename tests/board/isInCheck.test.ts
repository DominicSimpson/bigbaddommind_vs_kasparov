...
describe('isInCheck', () => {
    ...
    describe('pawn check detection', () => {
        it.each([
            [
                'detects that a white pawn on e7 checks a black king on d8',
                '3k4/4P3/8/8/8/8/8/3K4 b - - 0 1',
                'black',
                true,
            ],
            [
                'detects that a white pawn on d7 does not check a black king on d8',
                '3k4/3P4/8/8/8/8/8/3K4 b - - 0 1',
                'black',
                false,
            ],

            [
                'detects that a black pawn on c2 checks a white king on d1',
                '3k4/8/8/8/8/8/2p5/3K4 w - - 0 1',
                'white',
                true,
            ],
            [
                'detects that a black pawn on d2 does not check a white king on d1',
    ...
    describe('king check detection', () => {
        it.each([
            [
                'detects that a white king on c7 checks a black king on d8',
                '3k4/2K5/8/8/8/8/8/8 b - - 0 1',
                'black',
                true,
            ],
            [
                'detects that a white king on d6 does not check a black king on d8',
                '3k4/8/3K4/8/8/8/8/8 b - - 0 1',
                'black',
                false,
            ],

            [
                'detects that a black king on e2 checks a white king on d1',
            ...
            [
                'detects that a black king on d3 does not check a white king on d1',
